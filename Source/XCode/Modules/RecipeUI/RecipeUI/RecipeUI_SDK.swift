...
public class RecipeUI_SDK {
    ...
    public static func createRecipelistVC(title: String, router: RecipeRoute) -> CollectionViewController {
        ...
        let viewModel = CollectionViewModel(title: title, view: recipeListVC, router: router)
