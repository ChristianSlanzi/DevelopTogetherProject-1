...
extension CookingApiServiceTests {
    func expect(_ sut: CookingApiService, toCompleteWith expectedResult: Result<RecipesSearchResultDTO, CookingApiServiceError>, when action: () -> Void, file: StaticString = #file, line: UInt = #line) {
