//
//  RecipeStoreIntegrationTests.swift
//  RecipeStoreTests
//
//  Created by Christian Slanzi on 06.05.21.
//

import XCTest
import RecipeStore

class RecipeStoreIntegrationTests: XCTestCase {
    ...
    func test_insert_overridesFeedInsertedOnAnotherInstance() throws {
        ...
        insert((uniqueRecipeFeed(), Date()), to: storeToInsert)
    ...
    private func makeSUT(file: StaticString = #filePath, line: UInt = #line) throws -> RecipeStore {
        let sut = try CoreDataRecipeStore(storeURL: testSpecificStoreURL())
